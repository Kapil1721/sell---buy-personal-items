        ...
        <div className='w-full h-[100vh] lg:h-screen relative flex flex-col justify-center items-center'>
            ...
            <div className='relative z-20  flex flex-col justify-center items-center'>
                <div className='text-center mb-4'>
                    ...
                    <h1 className='text-2xl md:text-3xl lg:text-5xl xl:text-7xl font-bold text-[#3ebd8d]'>
                        A Second Chance!
                    </h1>
                </div>
              ...
              <svg xmlns='http://www.w3.org/2000/svg' width={18} height={18} viewBox='0 0 18 18' fill='none'>
                ...
                <div className='w-full flex justify-between flex-col items-center mt-10'>
                    ...
                    <div className='flex justify-between items-start gap-5 mt-5'>
                        <div className='rounded-full border border-white p-3 md:p-4 flex justify-center items-center transition ease-in-out group hover:border-[#1e62a4]'>
                            <svg
                                className='fill-white transition ease-in-out group-hover:fill-[#1e62a4]'
