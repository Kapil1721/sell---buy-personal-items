...
function Footer() {
    return (
        <footer className='relative w-full bg-[#374B5C]'>
            ...
            <div className='bg-black w-full text-xs lg:text-base text-center py-4'><p className='text-white'>Copyright © 2026 Buy Personal Items | Designed by <a href={'https://designbyzonewebsites.com'} target='blank'>Zone Websites</a></p></div>
        </footer>
    )
}
